...
module.exports = {
    ...
    extracaoDadosPassoArtista: function(artistaProcurado) {
    ...
    extracaoDadosPassoCidade: function(mbid, nomeArtistico, cidadeProcurada) {
    ...
    extracaoDadosPassoPais: function(mbid, nomeArtistico, paisProcurado, cidadeProcurada) {
    ...
    mbrainzFunction: function(mbid, nomeArtistico, json, type) {
